                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="mt-4 sm:mt-0">
                            ...
                            <ul className="space-y-2 md:space-y-3">
                                ...
                                <li>
                                    <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm md:text-base">About Us</a>
                                </li>
                                <li>
                                    <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm md:text-base">Services</a>
                                </li>
                                <li>
                                    <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm md:text-base">Gallery</a>
                                </li>
                                <li>
                                    <a href="#" className="text-gray-600 hover:text-primary transition-colors text-sm md:text-base">Contact</a>
                                </li>
                            </ul>
                        </div>
